...
use HydrogenAfrica\Hydrogen\HydrogenEventHandlerInterface;

class PaymentEventHandler implements HydrogenEventHandlerInterface {
    /**
     * This is called when the Hydrogen class is initialized
     * */
